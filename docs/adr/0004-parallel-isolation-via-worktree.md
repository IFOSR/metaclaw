...
- Dependent-parallel workflows (A+B then B-after-A) are **not solved by this ADR**. They need the deferred decomposition-DAG design. Until then, such workflows are handled as sequential work units across turns.
